...
16. Keyword search includes indexed PDF/DOCX text and OCR text from uploaded JPG/PNG files. Admin can manually rebuild the index from Advanced Search when needed. Scanned PDF images remain searchable by Dak metadata until PDF OCR rendering is integrated.
