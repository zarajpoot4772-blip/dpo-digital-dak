...
16. Keyword search includes indexed PDF/DOCX text. Admin can run Rebuild text index to OCR uploaded JPG/PNG files when needed. Scanned PDF images remain searchable by Dak metadata until PDF OCR rendering is integrated.
