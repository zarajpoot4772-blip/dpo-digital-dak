...
const translations: Array<[string, string]> = ([
  ...
  ['Keyword search includes indexed PDF/DOCX text and OCR text from uploaded JPG/PNG files. Scanned PDF images remain searchable by Dak metadata until PDF OCR rendering is integrated.', 'کلیدی لفظ کی تلاش PDF/DOCX کے متن اور اپ لوڈ شدہ JPG/PNG کے OCR متن میں بھی ہوتی ہے۔ اسکین شدہ PDF تصاویر PDF OCR شامل ہونے تک صرف ڈاک میٹا ڈیٹا سے تلاش ہوں گی۔'],
  ['Run OCR', 'OCR چلائیں'],
