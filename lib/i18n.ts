...
const translations: Array<[string, string]> = ([
  ...
  ['Due', 'آخری تاریخ'],
  ['OCR text', 'او سی آر متن'],
  ['Keyword search includes indexed PDF/DOCX text. Admin can run Rebuild text index to OCR uploaded JPG/PNG files when needed. Scanned PDF images remain searchable by Dak metadata until PDF OCR rendering is integrated.', 'کلیدی لفظ کی تلاش PDF/DOCX کے متن میں بھی ہوتی ہے۔ ایڈمن ضرورت کے وقت Rebuild text index چلا کر اپ لوڈ شدہ JPG/PNG پر OCR کر سکتا ہے۔ اسکین شدہ PDF تصاویر PDF OCR شامل ہونے تک صرف ڈاک میٹا ڈیٹا سے تلاش ہوں گی۔'],
  ['Run OCR', 'OCR چلائیں'],
