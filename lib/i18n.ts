...
const translations: Array<[string, string]> = ([
  ...
  ['Internal file noting', 'فائل کی اندرونی نوٹنگ'],
  ['Add internal note', 'اندرونی نوٹ شامل کریں'],
  ['Add note', 'نوٹ شامل کریں'],
  ['These notes are separate from the immutable incoming document and remain part of the file record.', 'یہ نوٹس ناقابلِ تبدیلی موصولہ دستاویز سے الگ ہیں اور فائل ریکارڈ کا حصہ رہتے ہیں۔'],
  ['No internal notes have been added yet.', 'ابھی کوئی اندرونی نوٹ شامل نہیں کیا گیا۔'],
  ['Maximum 2,000 characters', 'زیادہ سے زیادہ 2,000 حروف'],
  ['Write an internal instruction or observation…', 'اندرونی ہدایت یا مشاہدہ لکھیں…'],
  ['Finalized files are read-only; new internal notes are disabled.', 'حتمی فائلیں صرف پڑھنے کے لیے ہیں؛ نئے اندرونی نوٹس بند ہیں۔'],
  ['Internal note cannot be empty', 'اندرونی نوٹ خالی نہیں ہو سکتا'],
  ['Internal note added', 'اندرونی نوٹ شامل کر دیا گیا'],
  ['Dispatch', 'ارسال'],
  ['Outward dispatch register', 'بیرونی ارسال رجسٹر'],
  ['Record an outward response or dispatch linked to this inward Dak. Entries are append-only and audited.', 'اس موصولہ ڈاک سے منسلک بیرونی جواب یا ارسال ریکارڈ کریں۔ اندراجات صرف شامل کی جا سکتی ہیں اور آڈٹ ہوتی ہیں۔'],
  ['No outward dispatch has been registered yet.', 'ابھی کوئی بیرونی ارسال رجسٹر نہیں ہوئی۔'],
  ['Dispatch number (optional)', 'ارسال نمبر (اختیاری)'],
  ['Dispatch date', 'ارسال کی تاریخ'],
  ['Dispatch mode', 'ارسال کا طریقہ'],
  ['Courier', 'کورئیر'],
  ['Post', 'ڈاک'],
  ['Email', 'ای میل'],
  ['Hand delivery', 'بذریعہ دست'],
  ['Tracking / reference', 'ٹریکننگ / حوالہ'],
  ['Recipient', 'وصول کنندہ'],
  ['Recipient department', 'وصول کنندہ کا محکمہ'],
  ['Dispatch remarks (optional)', 'ارسال کے ریمارکس (اختیاری)'],
  ['Register dispatch', 'ارسال رجسٹر کریں'],
  ['Only finalized Dak can be dispatched.', 'صرف حتمی ڈاک ارسال کی جا سکتی ہے۔'],
  ['Outward dispatch can be registered after approval by Admin, DPO or Clerk.', 'Admin، DPO یا Clerk منظوری کے بعد بیرونی ارسال رجسٹر کر سکتے ہیں۔'],
  ['Registered by', 'رجسٹر کرنے والا'],
  ['Tracking/reference', 'ٹریکننگ/حوالہ'],
  ['Outward dispatch registered', 'بیرونی ارسال رجسٹر ہو گئی'],
  ['Dispatch recipient is required', 'ارسال کا وصول کنندہ ضروری ہے'],
  ['Valid dispatch date is required', 'ارسال کی درست تاریخ ضروری ہے'],
  ['Invalid dispatch mode', 'ارسال کا طریقہ درست نہیں'],
  ['Dispatch can be registered only after approval', 'ارسال صرف منظوری کے بعد رجسٹر کی جا سکتی ہے'],
  ['Dispatch number already exists', 'ارسال نمبر پہلے سے موجود ہے'],
